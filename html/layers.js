...
function createBaseLayers() {
    ...
    */
    ...
    us.push(createGeoJsonLayer('UND Practice Areas w/Lables', 'undpal', 'geojson/undpal.geojson', 'rgba(0, 154, 68, 0.5)', 'rgba(0, 154, 68, 0.5)', false));
    us.push(createGeoJsonLayer('UND Practice Areas', 'undpa', 'geojson/undpa.geojson', 'rgba(0, 154, 68, 0.5)', 'rgba(0, 154, 68, 0.5)', false));
